...
/**
 * TechDivision\Import\Product\Variant\Actions\Processors\Batch\ProductRelationPersistBatchProcessor
 *
 * NOTICE OF LICENSE
 *
...
/**
 * The product relation persist batch processor implementation.
 *
 * @author    Tim Wagner <tw@appserver.io>
 * @copyright 2015 TechDivision GmbH <info@appserver.io>
 * @license   http://opensource.org/licenses/osl-3.0.php Open Software License (OSL 3.0)
 ...
 * @link      http://www.appserver.io
 */
class ProductRelationPersistBatchProcessor extends AbstractPersistBatchProcessor
{
    ...
    {
        return SqlStatements::CREATE_PRODUCT_RELATION;
    }
}
