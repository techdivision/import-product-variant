...
/**
 * TechDivision\Import\Product\Variant\Loaders\RawEntityLoader
 *
 * PHP version 7
 *
...
namespace TechDivision\Import\Product\Variant\Loaders;
...
class RawEntityLoader implements LoaderInterface
{
     ...
     * @var array
     */
    protected $entityTypes = array(EntityTypeCodes::CATALOG_PRODUCT_SUPER_ATTRIBUTE);
